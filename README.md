...
> It has been adapted for a UR5e robot setup. For the main robot control and data collection setup, see the [lerobot_ur5e_gello](https://github.com/anonymous-icann26/lerobot-ur5e-gello) repository.
...
```bash
git clone --recurse-submodules git@github.com:anonymous-icann26/openpi-ur5e.git
